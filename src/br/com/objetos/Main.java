...
public class Main {
	...
	public static void main(String[] args) {
		...
		// M�todo Construtor padr�o da classe (sem nenhum param�tro);
		Empresa empresa = new Empresa();
		Remedio remedio = new Remedio();
		Livro livro = new Livro();
		Funcionario funcionario = new Funcionario();

		// Populando 3 Ojbetos de cada classe (Empresa/Rem�dio/Livro/Funcion�rio);
		...
		Remedio r1 = new Remedio("Ipubrofeno", "Vermelha", "Laborat�rio Sa�de", 13.75, 100);
		Remedio r2 = new Remedio("Roacutan", "Vermelha", "Laborat�rio Particular", 80.50, 50);
		Remedio r3 = new Remedio("Cefaliv", "Vermelha", "Laborat�rio dos Guri", 40.50, 75);
		...
		Livro l3 = new Livro("O Milagre da Manh�", "7639842", "Hal Elrod", "Editora Best Seller", 35.50, 121);
		
		Funcionario f1 = new Funcionario("Rodrigo", "Borges", "03865948239", "Estagi�rio", 1200);
		Funcionario f2 = new Funcionario("Renato", "Borges", "60625476938", "Auxiliar Geral", 1500);
		Funcionario f3 = new Funcionario("Aline", "Borges", "5795866973", "Gerente Pessoa F�sica", 3500);
		...
		do {
			...
			case 1:
				...
				// Alterando o valor
				if (num == 1) {
					System.out.println("Qual rem�dio quer alterar o valor?");
			...
			case 2:
				// Mostra as tr�s empresas e mostra o menu
				emp1.info(); emp2.info(); emp3.info();
				menuEmpresa();
				num = teclado.nextInt();
				if (num == 1) {
					System.out.println("Atualizar endere�o de qual empresa??");
					empresa.nomesEmpresa(emp1, emp2, emp3);
					opcao = teclado.nextInt();
					System.out.print("Novo Endere�o: ");
					// estou tendo dificuldade aqui, eu tento colocar .nextLine por�m da um bug na hora. e pula a linha do c�digo... 
				...
				break;
			case 3:
				// Mostra os tr�s funcion�rios e o menu
				f1.info(); f2.info();f3.info();
				menuFuncionario();
				num = teclado.nextInt();
				
				if (num == 1) {
					System.out.println("Atualizar o sal�rio de qual funcion�rio?");
					...
					System.out.println("Sal�rio Att\n");
					break;
				}
				if (num == 2) {
					System.out.println("Trocar de cargo qual funcion�rio?");
					funcionario.listaFuncionario(f1, f2, f3);
					opcao = teclado.nextInt();
	...
	public static void menuPrincipal() {
		System.out.println(" [1] Lista de Rem�dios");
		System.out.println(" [2] Lista de Empresas");
		System.out.println(" [3] Lista de Funcion�rios");
